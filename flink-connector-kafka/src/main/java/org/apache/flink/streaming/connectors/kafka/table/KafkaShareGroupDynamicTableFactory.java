 ...
 *
 * <p>This factory creates table sources that use Kafka 4.1.0+ share group semantics for queue-like
 * message consumption in Flink SQL applications.
 *
...
public class KafkaShareGroupDynamicTableFactory implements DynamicTableSourceFactory {
    ...
    public static final ConfigOption<String> SHARE_GROUP_ID =
    ...
    public static final ConfigOption<Boolean> ENABLE_SHARE_GROUP_METRICS =
    ...
    public static final ConfigOption<String> GROUP_TYPE =
    ...
    public static class KafkaShareGroupDynamicTableSource implements ScanTableSource {
        ...
        public ScanRuntimeProvider getScanRuntimeProvider(ScanContext context) {
            ...
            KafkaShareGroupSource<RowData> shareGroupSource =
                    KafkaShareGroupSource.<RowData>builder()
