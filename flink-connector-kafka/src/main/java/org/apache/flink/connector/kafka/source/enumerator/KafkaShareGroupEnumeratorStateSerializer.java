 ...
 * 
 * <p>This serializer handles the serialization and deserialization of share group
 * enumerator state for checkpointing and recovery purposes.
 */
public class KafkaShareGroupEnumeratorStateSerializer implements SimpleVersionedSerializer<KafkaShareGroupEnumeratorState> {
    ...
    @Override
    public KafkaShareGroupEnumeratorState deserialize(int version, byte[] serialized) throws IOException {
