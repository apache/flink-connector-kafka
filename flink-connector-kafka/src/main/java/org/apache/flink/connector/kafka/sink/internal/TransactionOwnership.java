    ...
    EXPLICIT_BY_WRITER_STATE {
        ...
        private void assertKnown(int ownershipValue) {
            checkState(
                    ...
                    "Attempted to migrate from flink-connector-kafka 3.X directly to a naming strategy that uses the writer state. Please first migrate to a flink-connector-kafka 4.X with INCREMENTING.");
        }
    };
