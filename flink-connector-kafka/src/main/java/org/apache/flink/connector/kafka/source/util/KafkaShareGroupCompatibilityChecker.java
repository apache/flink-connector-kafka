...
/**
 * Utility class to check if the Kafka cluster supports share group functionality (KIP-932). This is
 * required for queue semantics in KafkaQueueSource.
 */
public class KafkaShareGroupCompatibilityChecker {
    private static final Logger LOG =
            LoggerFactory.getLogger(KafkaShareGroupCompatibilityChecker.class);
    ...
    public static ShareGroupCompatibilityResult checkShareGroupSupport(Properties kafkaProperties) {
        ...
        try {
            ...
            ShareGroupCompatibilityResult consumerApiResult =
                    checkConsumerApiSupport(kafkaProperties);
    ...
    private static ShareGroupCompatibilityResult checkBrokerVersion(Properties kafkaProperties) {
        ...
        try {
            ...
            if (bootstrapServers == null || bootstrapServers.trim().isEmpty()) {
                return ShareGroupCompatibilityResult.unsupported(
                        "No bootstrap servers configured", "Set bootstrap.servers property");
            }
    ...
    private static ShareGroupCompatibilityResult checkConsumerApiSupport(
        ...
        try {
            ...
            if ("share".equals(groupType)) {
                ...
                return ShareGroupCompatibilityResult.supported(
                        "Share group configuration is valid");
            }
    ...
    public static class ShareGroupCompatibilityResult {
        ...
        private ShareGroupCompatibilityResult(
                boolean supported, String message, String recommendation) {
        ...
        public static ShareGroupCompatibilityResult unsupported(
