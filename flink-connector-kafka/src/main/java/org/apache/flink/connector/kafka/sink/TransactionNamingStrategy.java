...
public enum TransactionNamingStrategy {
     ...
     * corresponds to the checkpoint id. This strategy is the most wasteful in terms of resource
     * consumption on the broker.
     *
     * <p>This strategy supports all abort strategies.
     *
     ...
     */
    private final Set<TransactionAbortStrategy> supportedAbortStrategies;

    TransactionNamingStrategy(
            TransactionNamingStrategyImpl impl,
            EnumSet<TransactionAbortStrategy> supportedAbortStrategies) {
        this.impl = impl;
